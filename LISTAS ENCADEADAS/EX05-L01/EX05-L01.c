...
void removeK(LISTA* lista, int k){
    if(*lista == NULL || k <= 0) {
        return;
    }
    if(k == 1){
...
int quantidadePrimos(LISTA* lista){
    int cont = 0;
    node *atual = *lista;
    while(atual != NULL){
        if(Primo(atual->num)){
...
void main(){
    ...
    do{
        ...
        printf("11)Remove k-ésimo nó da lista\n");
        printf("12)Quantidade de números primos na lista\n");
        printf("0)Sair\n");
        scanf("%d",&op);
        switch(op){
            case 1:
            ...
            case 11:
                ...
                Ordena(lista);
                exibe(lista);
                printf("Digite o nó que deseja remover: ");
                scanf("%d",&k);
                removeK(lista,k);
                system("cls");
                break;
            case 12:
                system("cls");
                quant = quantidadePrimos(lista);
                printf("\nA quantidade de números primos é de: %d\n",quant);
                system("pause");
                system("cls");
                break;
            default:
